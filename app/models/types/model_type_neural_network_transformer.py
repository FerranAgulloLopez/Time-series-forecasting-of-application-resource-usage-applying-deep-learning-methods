...
class ModelTypeNeuralNetworkTransformer(ModelTypeInterface):
    ...
    def __predict_network(self, data_loader: DataLoader):
        ...
        with torch.no_grad():
            for index, (ids, train_values_x, train_values_x_mark, train_values_y, train_values_y_mark, _) in enumerate(data_loader, 0):  # iterate data loader
                train_values_x = train_values_x.to(self.device)
                train_values_x_mark = train_values_x_mark.to(self.device)
                train_values_y = train_values_y.to(self.device)
                train_values_y_mark = train_values_y_mark.to(self.device)

                prediction = self.network.predict(train_values_x, train_values_y, train_values_x_mark, train_values_y_mark)
    ...
    def __train_epoch(self, number_epoch: int, train_data_loader: DataLoader, losses_array: torch.Tensor):
        ...
        for index, (_, train_values_x, train_values_x_mark, train_values_y, train_values_y_mark, train_target) in enumerate(train_data_loader, 0):  # iterate data loader
            ts = time()
            ...
            train_output = self.network(train_values_x, train_values_y, train_values_x_mark, train_values_y_mark, train_target)
    ...
    def __not_train_epoch(self, number_epoch: int, data_loader: DataLoader, losses_array: torch.Tensor):
        ...
        with torch.no_grad():
            for index, (_, train_values_x, train_values_x_mark, train_values_y, train_values_y_mark, target) in enumerate(data_loader, 0):  # iterate data loader
                train_values_x = train_values_x.to(self.device)
                train_values_x_mark = train_values_x_mark.to(self.device)
                train_values_y = train_values_y.to(self.device)
                train_values_y_mark = train_values_y_mark.to(self.device)
                ...
                output = self.network(train_values_x, train_values_y, train_values_x_mark, train_values_y_mark, target)
